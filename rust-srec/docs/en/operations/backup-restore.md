...
3. Restore `.env` and Compose configuration. Do not generate a new `JWT_SECRET` during a like-for-like restore unless invalidating all access tokens is intended.
