...
- Current release version: `v0.5.0`
...
- English release page: [`/en/release-notes/v0.5.0`](./en/release-notes/v0.5.0.md)
- 中文更新日志归档：[`/zh/release-notes/`](./zh/release-notes/index.md)
- 中文文档页面：[`/zh/release-notes/v0.5.0`](./zh/release-notes/v0.5.0.md)
