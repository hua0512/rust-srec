...
import { z } from 'zod';
import { ChevronLeft, Loader2, Rocket, FileText, User, Video, Info } from 'lucide-react';
...
import { createPipelineJob, listSessions, listStreamers } from '@/server/functions';
...
const createPipelineSchema = z.object({
    ...
    input_paths: z.array(z.string()).min(1, t`At least one input path is required`),
                            ...
                            <Card className="p-6 border-white/5 bg-background/40 backdrop-blur-xl dark:bg-card/30 shadow-2xl relative overflow-hidden h-full">
                                <div className="relative z-10 flex flex-col h-full">
                                    <PipelineWorkflowEditor
                                        ...
                                        onChange={(steps) => form.setValue('steps', steps, { shouldDirty: true, shouldValidate: true })}
                                    />
