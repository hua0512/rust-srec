                ...
                <div className="max-w-[1600px] mx-auto">
                    ...
                    <div className="flex flex-col md:flex-row gap-4 items-start md:items-center justify-between p-4 md:px-8">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                <h1 className="text-xl font-semibold tracking-tight"><Trans>Media Outputs</Trans></h1>
                        ...
                        <div className="flex items-center gap-2 w-full md:w-auto">
                            ...
                            <Badge variant="outline" className="h-9 px-3 text-sm whitespace-nowrap">
                            ...
                            <div className="space-y-2 max-w-md">
                                ...
                                <p className="text-muted-foreground">
                                    {debouncedSearch || selectedFormat
                                        ...
                                        : <Trans>Media outputs will appear here when pipeline jobs complete.</Trans>
                                    }
                                </p>
                            </div>
                        </motion.div>
