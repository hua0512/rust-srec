...
function WorkflowsPage() {
    ...
    const deleteMutation = useMutation({
        ...
        onError: (error) => toast.error(t`Failed to delete workflow: ${error.message}`),
    });
    ...
    const handleEdit = (workflow: PipelinePreset) => {
        navigate({ to: '/pipeline/workflows/$workflowId', params: { workflowId: workflow.id } });
    };
                ...
                <div className="max-w-[1600px] mx-auto">
                    <div className="flex flex-col md:flex-row gap-4 items-start md:items-center justify-between p-4 md:px-8">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                <h1 className="text-xl font-semibold tracking-tight"><Trans>Workflows</Trans></h1>
                                <p className="text-sm text-muted-foreground">
                                    <Trans>Define sequences of processing steps for your recordings</Trans>
                                </p>
                            </div>
                        </div>
                        ...
                        >
                            ...
                            <div className="space-y-2 max-w-md">
                                <h3 className="font-semibold text-2xl tracking-tight">
                                    {debouncedSearch ? <Trans>No workflows found</Trans> : <Trans>No workflows yet</Trans>}
                                </h3>
                                <p className="text-muted-foreground">
                                    {debouncedSearch
                                        ? <Trans>Try adjusting your search.</Trans>
                                        : <Trans>Create your first workflow to define a sequence of processing steps for your recordings.</Trans>
                                    }
                                </p>
                            </div>
                            {!debouncedSearch && (
