    ...
    return (
        <div className="space-y-4">
            <FormField
                ...
                render={({ field }) => (
                    <FormItem>
                        <FormLabel><Trans>Keywords</Trans></FormLabel>
                        <FormControl>
                            <TagInput
                                {...field}
                ...
                render={({ field }) => (
                    <FormItem className="flex flex-row items-center justify-between rounded-lg border p-4">
                        <div className="space-y-0.5">
                            ...
                            <FormDescription>
                                <Trans>If enabled, streams matching these keywords will be ignored.</Trans>
                            </FormDescription>
                        </div>
                        <FormControl>
                            <Switch
            ...
            <FormField
                ...
                render={({ field }) => (
                    <FormItem className="flex flex-row items-center justify-between rounded-lg border p-4">
                        <div className="space-y-0.5">
                            <FormLabel className="text-base"><Trans>Case Sensitive</Trans></FormLabel>
                        </div>
                        <FormControl>
                            <Switch
                                checked={field.value}
