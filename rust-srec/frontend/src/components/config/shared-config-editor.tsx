    ...
    return (
        <Tabs defaultValue={defaultTab} className="w-full">
            ...
            <div className="mt-6">
                ...
                {showTab('filters') && (
                    <TabsContent value="filters" className="mt-0 focus-visible:outline-none">
                        <motion.div variants={tabContentVariants} initial="hidden" animate="visible" exit="exit">
                    ...
                    <TabsContent value="output" className="mt-0 focus-visible:outline-none">
                        <motion.div variants={tabContentVariants} initial="hidden" animate="visible" exit="exit">
                            <div className="space-y-6">
                                <OutputSettingsCard form={form} basePath={paths.output === '' ? undefined : paths.output} engines={engines} />
                                <LimitsCard form={form} basePath={paths.limits === '' ? undefined : paths.limits} />
                            </div>
                        </motion.div>
                    </TabsContent>
                )}
                ...
                {showTab('network') && (
                    <TabsContent value="network" className="mt-0 focus-visible:outline-none">
                        <motion.div variants={tabContentVariants} initial="hidden" animate="visible" exit="exit">
                            <NetworkSettingsCard
                                form={form}
                                paths={{ cookies: paths.cookies, retryPolicy: paths.retryPolicy }}
                ...
                {showTab('proxy') && (
                    <TabsContent value="proxy" className="mt-0 focus-visible:outline-none">
                        <motion.div variants={tabContentVariants} initial="hidden" animate="visible" exit="exit">
                            <ProxySettingsCard
                                form={form}
                                name={paths.proxy}
                ...
                {showTab('danmu') && (
                    <TabsContent value="danmu" className="mt-0 focus-visible:outline-none">
                        <motion.div variants={tabContentVariants} initial="hidden" animate="visible" exit="exit">
                            <Card className="border-dashed shadow-none">
                                <CardContent className="pt-6">
                                    <RecordDanmuCard form={form} basePath={paths.danmu === '' ? undefined : paths.danmu} />
