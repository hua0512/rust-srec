        ...
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            <Button
              variant="ghost"
              size="icon"
              className="h-8 w-8 -mr-2 text-muted-foreground/70 hover:text-foreground transition-colors"
            >
        ...
        <div className="grid grid-cols-2 gap-3">
          ...
          {platform.output_folder && (
            <div className="col-span-2 flex flex-col gap-0.5 bg-muted/40 rounded-lg px-3 py-2 border border-border/50 group-hover:border-primary/10 transition-colors">
              ...
              <span
                className="text-xs font-semibold truncate text-foreground/90 font-mono"
                title={platform.output_folder}
              >
                {platform.output_folder}
              </span>
            </div>
