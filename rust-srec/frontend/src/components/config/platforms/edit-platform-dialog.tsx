            ...
            <DialogContent className="max-w-2xl max-h-[85vh] overflow-hidden flex flex-col p-0 gap-0">
                <DialogHeader className="p-6 pb-2">
                    ...
                    <DialogDescription className="pl-11">
                        <Trans>Configure platform behavior, authentication, and advanced settings.</Trans>
                    </DialogDescription>
                </DialogHeader>
                ...
                <Form {...form}>
                    <form onSubmit={form.handleSubmit(onSubmit)} className="flex-1 overflow-hidden flex flex-col">
                        <div className="flex-1 overflow-y-auto p-6 pt-2">
                            <Tabs defaultValue="general" className="w-full">
                                <TabsList className="flex flex-wrap h-auto w-full justify-start gap-2 bg-transparent p-0 mb-4">
                                    <TabsTrigger value="general" className="gap-2 px-4 py-2 h-9 data-[state=active]:bg-primary data-[state=active]:text-primary-foreground border bg-muted/40 hover:bg-muted/60 transition-colors shadow-sm rounded-md flex-grow md:flex-grow-0 ring-offset-background focus-visible:ring-2 focus-visible:ring-ring">
                                        <Settings className="w-4 h-4" />
                                        <span className="whitespace-nowrap"><Trans>General</Trans></span>
                                    </TabsTrigger>
                                    <TabsTrigger value="stream-selection" className="gap-2 px-4 py-2 h-9 data-[state=active]:bg-primary data-[state=active]:text-primary-foreground border bg-muted/40 hover:bg-muted/60 transition-colors shadow-sm rounded-md flex-grow md:flex-grow-0 ring-offset-background focus-visible:ring-2 focus-visible:ring-ring">
                                        <Filter className="w-4 h-4" />
                                        <span className="whitespace-nowrap"><Trans>Stream Selection</Trans></span>
                                    </TabsTrigger>
                                    <TabsTrigger value="auth" className="gap-2 px-4 py-2 h-9 data-[state=active]:bg-primary data-[state=active]:text-primary-foreground border bg-muted/40 hover:bg-muted/60 transition-colors shadow-sm rounded-md flex-grow md:flex-grow-0 ring-offset-background focus-visible:ring-2 focus-visible:ring-ring">
                                        <Cookie className="w-4 h-4" />
                                        <span className="whitespace-nowrap"><Trans>Authentication</Trans></span>
                                    </TabsTrigger>
                                    <TabsTrigger value="proxy" className="gap-2 px-4 py-2 h-9 data-[state=active]:bg-primary data-[state=active]:text-primary-foreground border bg-muted/40 hover:bg-muted/60 transition-colors shadow-sm rounded-md flex-grow md:flex-grow-0 ring-offset-background focus-visible:ring-2 focus-visible:ring-ring">
                                        <Shield className="w-4 h-4" />
                                        <span className="whitespace-nowrap"><Trans>Proxy</Trans></span>
                                    </TabsTrigger>
                                    <TabsTrigger value="advanced" className="gap-2 px-4 py-2 h-9 data-[state=active]:bg-primary data-[state=active]:text-primary-foreground border bg-muted/40 hover:bg-muted/60 transition-colors shadow-sm rounded-md flex-grow md:flex-grow-0 ring-offset-background focus-visible:ring-2 focus-visible:ring-ring">
                        ...
                        <DialogFooter className="p-6 pt-2 border-t mt-auto bg-muted/30">
                            ...
                            <Button type="submit" disabled={updateMutation.isPending} className="bg-primary/90 hover:bg-primary">
