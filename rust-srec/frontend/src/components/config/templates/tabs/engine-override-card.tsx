...
export function EngineOverrideCard({
  engineId,
  engineName,
  engineType,
  form,
  ...
  return (
    <Card className="relative overflow-hidden transition-all duration-200 border-border/50 shadow-sm hover:shadow-md hover:border-primary/20">
      <CardHeader className="pb-3 border-b flex flex-row items-center justify-between space-y-0 bg-muted/5">
