      ...
      <DialogContent className="max-w-2xl max-h-[85vh] overflow-hidden flex flex-col p-0 gap-0">
        <DialogHeader className="p-6 pb-2">
          <DialogTitle className="flex items-center gap-2 text-xl">
            ...
            {isEditing ? (
              <Trans>Edit {template.name}</Trans>
            ) : (
              <Trans>Create Template</Trans>
            )}
          </DialogTitle>
                  ...
                  <FormControl>
                    <div className="w-full overflow-x-auto pb-2 -mb-2">
                      <TabsList className="flex flex-wrap h-auto w-fit justify-start gap-2 bg-transparent p-0 mb-4">
                        <TabsTrigger
                          value="general"
                          className="gap-2 px-4 py-2 h-9 data-[state=active]:bg-primary data-[state=active]:text-primary-foreground border bg-muted/40 hover:bg-muted/60 transition-colors shadow-sm rounded-full ring-offset-background focus-visible:ring-2 focus-visible:ring-ring"
                        >
