            ...
            <div className="grid grid-cols-2 p-1 bg-muted/40 rounded-xl border border-border/40 backdrop-blur-sm">
                <button
                    ...
                    className={cn(
                        ...
                        mode === 'single' ? "text-primary-foreground shadow-sm" : "text-muted-foreground hover:text-foreground hover:bg-muted/50"
                    )}
                >
                    {mode === 'single' && (
                        <motion.div
                ...
                <button
                    ...
                    className={cn(
                        "relative flex items-center justify-center gap-2 py-2.5 text-sm font-medium rounded-lg transition-all duration-300",
                        mode === 'batch' ? "text-primary-foreground shadow-sm" : "text-muted-foreground hover:text-foreground hover:bg-muted/50"
                    )}
                >
                    {mode === 'batch' && (
                        <motion.div
