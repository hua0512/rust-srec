...
export function ThumbnailConfigForm({ control, pathPrefix }: ProcessorConfigFormProps<ThumbnailConfig>) {
            ...
            <div className="space-y-6">
                <div className="p-4 rounded-xl bg-muted/10 border border-border/40 space-y-4">
                    <div className="flex items-center gap-2 pb-2 border-b border-border/40 mb-2">
                        ...
                        <h3 className="font-semibold text-sm mr-auto"><Trans>Capture Settings</Trans></h3>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    <FormLabel className="text-xs text-muted-foreground ml-1"><Trans>Timestamp</Trans></FormLabel>
                                    <FormControl>
                                        <InputWithUnit
                                            unitType="duration"
                                            min={0}
                        ...
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    <FormLabel className="text-xs text-muted-foreground ml-1"><Trans>Width</Trans></FormLabel>
                                    <FormControl>
                                        <Input
                        ...
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    <FormLabel className="text-xs text-muted-foreground ml-1"><Trans>Quality (qscale)</Trans></FormLabel>
                                    <FormControl>
                                        <Input
                                            className="h-11 bg-background/50 border-border/50 focus:bg-background rounded-lg font-mono text-sm"
                                            type="number"
                ...
                <div className="p-4 rounded-xl bg-muted/10 border border-border/40 space-y-4">
                    <div className="flex items-center gap-2 pb-2 border-b border-border/40 mb-2">
                        ...
                        <h3 className="font-semibold text-sm mr-auto"><Trans>Output</Trans></h3>
                    </div>
                    ...
                    <div className="grid grid-cols-1 gap-6">
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    <FormLabel className="text-xs text-muted-foreground ml-1"><Trans>Output Pattern (Optional)</Trans></FormLabel>
                                    <FormControl>
                                        <Input
                                            className="h-11 bg-background/50 border-border/50 focus:bg-background rounded-lg font-mono text-sm"
                                            {...field}
