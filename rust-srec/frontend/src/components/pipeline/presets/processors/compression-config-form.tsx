...
export function CompressionConfigForm({ control, pathPrefix }: ProcessorConfigFormProps<CompressionConfig>) {
            ...
            <div className="space-y-6">
                <div className="p-4 rounded-xl bg-muted/10 border border-border/40 space-y-4">
                    <div className="flex items-center gap-2 pb-2 border-b border-border/40 mb-2">
                        ...
                        <h3 className="font-semibold text-sm mr-auto"><Trans>Archive Settings</Trans></h3>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    <FormLabel className="text-xs text-muted-foreground ml-1"><Trans>Archive Format</Trans></FormLabel>
                        ...
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    <FormLabel className="text-xs text-muted-foreground ml-1"><Trans>Compression Level</Trans></FormLabel>
                                    <FormControl>
                                        <Input
                            ...
                            render={({ field }) => (
                                <FormItem className="flex flex-row items-center justify-between rounded-lg border border-border/40 p-4 shadow-sm bg-muted/10 transition-colors hover:bg-muted/20">
                                    <div className="space-y-1">
                                        <FormLabel className="text-sm font-medium"><Trans>Preserve Paths</Trans></FormLabel>
