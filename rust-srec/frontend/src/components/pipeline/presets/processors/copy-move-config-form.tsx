...
export function CopyMoveConfigForm({ control, pathPrefix }: ProcessorConfigFormProps<CopyMoveConfig>) {
            ...
            <div className="space-y-6">
                <div className="p-4 rounded-xl bg-muted/10 border border-border/40 space-y-4">
                    <div className="flex items-center gap-2 pb-2 border-b border-border/40 mb-2">
                        ...
                        <h3 className="font-semibold text-sm mr-auto"><Trans>Operation</Trans></h3>
                    </div>
                    ...
                    <div className="grid grid-cols-1 gap-6">
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    <FormLabel className="text-xs text-muted-foreground ml-1"><Trans>Operation Type</Trans></FormLabel>
                                    <Select onValueChange={field.onChange} defaultValue={field.value}>
                                        ...
                                        <SelectContent>
                                            <SelectItem value="copy"><Trans>Copy Files</Trans></SelectItem>
                                            <SelectItem value="move"><Trans>Move Files</Trans></SelectItem>
                                        </SelectContent>
                                    </Select>
                                    <FormMessage />
                                </FormItem>
                        ...
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    <FormLabel className="text-xs text-muted-foreground ml-1"><Trans>Destination Path (Optional)</Trans></FormLabel>
                                    <FormControl>
                                        <Input
                ...
                <div className="space-y-4">
                    <div className="flex items-center gap-2 pb-2 border-b border-border/40">
                        ...
                        <h3 className="font-semibold text-sm mr-auto"><Trans>Options</Trans></h3>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            render={({ field }) => (
                                <FormItem className="flex flex-row items-center justify-between rounded-xl border border-border/40 p-4 shadow-sm bg-muted/10 transition-colors hover:bg-muted/20">
                                    <div className="space-y-1">
                                        <FormLabel className="text-sm font-medium"><Trans>Create Directories</Trans></FormLabel>
                        ...
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem className="flex flex-row items-center justify-between rounded-xl border border-border/40 p-4 shadow-sm bg-muted/10 transition-colors hover:bg-muted/20">
                                    <div className="space-y-1">
                                        <FormLabel className="text-sm font-medium"><Trans>Verify Integrity</Trans></FormLabel>
                                        <FormDescription className="text-xs">
