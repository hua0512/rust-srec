...
export function AudioExtractConfigForm({ control, pathPrefix }: ProcessorConfigFormProps<AudioExtractConfig>) {
                    ...
                    <TabsContent value="general" className="space-y-4 focus-visible:outline-none focus-visible:ring-0">
                        <div className="space-y-4 p-4 rounded-xl bg-muted/10 border border-border/40">
                            <div className="flex items-center gap-2 pb-2 border-b border-border/40 mb-2">
                                ...
                                <h3 className="font-semibold text-sm mr-auto"><Trans>Output Settings</Trans></h3>
                            </div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <FormField
                                    ...
                                    render={({ field }) => (
                                        <FormItem>
                                            <FormLabel className="text-xs text-muted-foreground ml-1"><Trans>Format</Trans></FormLabel>
                                ...
                                <FormField
                                    ...
                                    render={({ field }) => (
                                        <FormItem>
                                            <FormLabel className="text-xs text-muted-foreground ml-1"><Trans>Bitrate</Trans></FormLabel>
                                            <FormControl>
                                                <Input className="h-11 bg-background/50 border-border/50 focus:bg-background rounded-lg font-mono text-sm" placeholder="128k" {...field} />
                                            </FormControl>
                                            <FormDescription className="text-[11px] ml-1">
                    ...
                    <TabsContent value="advanced" className="space-y-6 focus-visible:outline-none focus-visible:ring-0">
                        <div className="p-4 rounded-xl bg-muted/10 border border-border/40 space-y-4">
                            <div className="flex items-center gap-2 pb-2 border-b border-border/40">
                                ...
                                <h3 className="font-semibold text-sm mr-auto"><Trans>Audio Properties</Trans></h3>
                            </div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <FormField
                                    ...
                                    render={({ field }) => (
                                        <FormItem>
                                            <FormLabel className="text-xs text-muted-foreground ml-1"><Trans>Sample Rate (Hz)</Trans></FormLabel>
                                            <FormControl>
                                                <Input
                                ...
                                <FormField
                                    ...
                                    render={({ field }) => (
                                        <FormItem>
                                            <FormLabel className="text-xs text-muted-foreground ml-1"><Trans>Channels</Trans></FormLabel>
                                            <FormControl>
                                                <Input
                                                    className="h-11 bg-background/50 border-border/50 focus:bg-background rounded-lg font-mono text-sm"
                                                    type="number"
                                    ...
                                    <FormItem className="flex flex-row items-center justify-between rounded-xl border border-border/40 p-4 shadow-sm bg-muted/10 transition-colors hover:bg-muted/20">
                                        <div className="space-y-1">
                                            ...
                                            <FormDescription className="text-xs">
                                                <Trans>Replace output files if they already exist</Trans>
                                            </FormDescription>
                                        </div>
                                        <FormControl>
                                            <Switch
