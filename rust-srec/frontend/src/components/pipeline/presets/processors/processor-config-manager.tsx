...
export function ProcessorConfigManager({ processorType, control, pathPrefix }: ProcessorConfigManagerProps) {
    ...
    switch (processorType) {
        ...
        case "audio_extract":
            return <AudioExtractConfigForm control={control} pathPrefix={pathPrefix} />;
        case "compression":
            return <CompressionConfigForm control={control} pathPrefix={pathPrefix} />;
        case "copy_move":
        ...
        default:
            return <div className="text-muted-foreground italic">No configuration available for this processor.</div>;
    }
}
