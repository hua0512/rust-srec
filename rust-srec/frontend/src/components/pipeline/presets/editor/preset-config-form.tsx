        ...
        <CardHeader className="pb-6 border-b border-border/40 bg-muted/10">
          <div className="flex justify-between items-center">
            ...
            <div className="flex gap-2">
              {currentProcessor === 'remux' && (
                <>
                  <Button
                    ...
                    variant="secondary"
                    size="sm"
                    onClick={() => loadTemplate('remux')}
                    className="h-8 text-xs font-medium bg-secondary/50 hover:bg-secondary text-secondary-foreground gap-1.5 rounded-lg transition-colors"
                  >
                  ...
                  <Button
                    ...
                    variant="secondary"
                    size="sm"
                    onClick={() => loadTemplate('transcode_h264')}
                    className="h-8 text-xs font-medium bg-secondary/50 hover:bg-secondary text-secondary-foreground gap-1.5 rounded-lg transition-colors"
                  >
              ...
              {(currentProcessor === 'upload' ||
                currentProcessor === 'rclone') && (
                <Button
                  type="button"
                  variant="secondary"
                  size="sm"
                  onClick={() => loadTemplate('rclone')}
                  className="h-8 text-xs font-medium bg-secondary/50 hover:bg-secondary text-secondary-foreground gap-1.5 rounded-lg transition-colors"
                >
