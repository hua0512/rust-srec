...
// --- Remux Processor ---
export const VideoCodecSchema = z.enum(["copy", "h264", "h265", "hevc", "vp9", "av1"]);
export const AudioCodecSchema = z.enum(["copy", "aac", "mp3", "opus", "flac"]);
export const PresetSchema = z.enum(["ultrafast", "superfast", "veryfast", "faster", "fast", "medium", "slow", "slower", "veryslow"]);
