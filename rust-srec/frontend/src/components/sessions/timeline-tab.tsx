            ...
            {titles.length === 0 ? (
                <div className="text-center py-20 text-muted-foreground flex flex-col items-center gap-6">
                    ...
                    <div className="space-y-1">
                        <p className="text-lg font-medium text-foreground">No Title Changes</p>
                        <p className="text-sm">The stream title remained constant throughout the session.</p>
                    </div>
                </div>
            ) : (
                                ...
                                >
                                    ...
                                    <div className="absolute left-8 md:left-1/2 -translate-x-1/2 flex flex-col items-center justify-center">
                                        <div className={cn(
                                            ...
                                            isLast ? "bg-primary border-primary/20 ring-4 ring-primary/10" : "bg-card border-border"
                                        )}>
                                            {isLast ? (
                                    ...
                                    {/* Content Card */}
                                    <div className={cn(
                                        "w-full md:w-1/2 pl-20 md:pl-0 md:px-12",
                                    )}>
                                            ...
                                            <CardContent className="p-5">
                                                <div className="flex flex-col gap-1">
                                                    <div className="flex items-center gap-2 mb-2">
                                                        <Badge variant={isFirst ? "secondary" : "outline"} className="text-[10px] tracking-wider font-normal">
                                                    ...
                                                    {i > 0 && titles[i - 1] && (
                                                        <div className="mt-4 pt-3 border-t border-border/30">
                                                            <div className="text-[10px] uppercase tracking-widest text-muted-foreground/50 mb-1.5">Previous Title</div>
