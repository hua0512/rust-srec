                            ...
                            <div className="space-y-2">
                                ...
                                <div className="flex items-center gap-6 text-sm text-muted-foreground font-medium pt-1">
                                    <div className="flex items-center gap-2">
                                        ...
                                        <span>{session.danmu_count?.toLocaleString() || 0} Danmu</span>
                                    </div>
                                    <div className="flex items-center gap-2">
                                ...
                                {thumbnailUrl ? (
                                    <>
                                        ...
                                        <motion.div
                                            ...
                                            onClick={() => outputs[0] && onPlay(outputs[0])}
                                        >
                                            {outputs.length > 0 ? (
                        ...
                        <CardContent className="p-6">
                            <div className="flex flex-col gap-6">
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    <TimeBlock label={t`Started`} date={session.start_time} icon={Calendar} delay={0} />
                                    <TimeBlock label={t`Ended`} date={session.end_time} icon={Timer} delay={0.1} />
                                </div>
                            </div>
                        </CardContent>
                    </Card>
    ...
    return (
        ...
        >
            ...
            <div className="text-[10px] text-muted-foreground/60">
                {date ? format(new Date(date), 'MMM d, yyyy') : 'In active'}
            </div>
        </motion.div>
    )
}
