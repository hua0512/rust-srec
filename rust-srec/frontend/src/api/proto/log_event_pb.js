...
export const log_event = $root.log_event = (() => {
    ...
    log_event.WsMessage = (function() {
        ...
        WsMessage.encode = function encode(message, writer) {
            ...
            if (message.log != null && Object.hasOwnProperty.call(message, "log"))
                $root.log_event.LogEvent.encode(message.log, writer.uint32(/* id 2, wireType 2 =*/18).fork()).ldelim();
            if (message.error != null && Object.hasOwnProperty.call(message, "error"))
                $root.log_event.ErrorPayload.encode(message.error, writer.uint32(/* id 3, wireType 2 =*/26).fork()).ldelim();
            return writer;
        };
        ...
        WsMessage.decode = function decode(reader, length, error) {
            ...
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.log_event.WsMessage();
            while (reader.pos < end) {
                ...
                case 2: {
                        message.log = $root.log_event.LogEvent.decode(reader, reader.uint32());
                        break;
                    }
                case 3: {
                        message.error = $root.log_event.ErrorPayload.decode(reader, reader.uint32());
                        break;
                    }
                default:
        ...
        WsMessage.fromObject = function fromObject(object) {
            if (object instanceof $root.log_event.WsMessage)
                return object;
        ...
        WsMessage.toObject = function toObject(message, options) {
            ...
            if (message.eventType != null && message.hasOwnProperty("eventType"))
                object.eventType = options.enums === String ? $root.log_event.EventType[message.eventType] === undefined ? message.eventType : $root.log_event.EventType[message.eventType] : message.eventType;
            if (message.log != null && message.hasOwnProperty("log")) {
            ...
            if (message.error != null && message.hasOwnProperty("error")) {
                object.error = $root.log_event.ErrorPayload.toObject(message.error, options);
                if (options.oneofs)
    ...
    log_event.LogEvent = (function() {
         ...
         * @instance
         */
        LogEvent.prototype.timestampMs = $util.Long ? $util.Long.fromBits(0,0,false) : 0;
        ...
        LogEvent.decode = function decode(reader, length, error) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.log_event.LogEvent();
            while (reader.pos < end) {
                let tag = reader.uint32();
                if (tag === error)
                    break;
        ...
        LogEvent.fromObject = function fromObject(object) {
            if (object instanceof $root.log_event.LogEvent)
                return object;
        ...
        LogEvent.toObject = function toObject(message, options) {
            ...
            if (message.level != null && message.hasOwnProperty("level"))
                object.level = options.enums === String ? $root.log_event.LogLevel[message.level] === undefined ? message.level : $root.log_event.LogLevel[message.level] : message.level;
            if (message.target != null && message.hasOwnProperty("target"))
    ...
    log_event.ErrorPayload = (function() {
        ...
        ErrorPayload.decode = function decode(reader, length, error) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.log_event.ErrorPayload();
            while (reader.pos < end) {
                let tag = reader.uint32();
                if (tag === error)
                    break;
        ...
        ErrorPayload.fromObject = function fromObject(object) {
            if (object instanceof $root.log_event.ErrorPayload)
                return object;
