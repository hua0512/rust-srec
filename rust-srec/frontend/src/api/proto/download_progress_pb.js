...
export const download_progress = ($root.download_progress = (() => {
  ...
  download_progress.WsMessage = (function () {
    ...
    WsMessage.encode = function encode(message, writer) {
      ...
      if (
        ...
        Object.hasOwnProperty.call(message, 'snapshot')
      )
        $root.download_progress.DownloadSnapshot.encode(
          message.snapshot,
          writer.uint32(/* id 2, wireType 2 =*/ 18).fork(),
        ).ldelim();
      if (
        message.downloadStarted != null &&
        Object.hasOwnProperty.call(message, 'downloadStarted')
      )
        $root.download_progress.DownloadStarted.encode(
      ...
      if (
        ...
        $root.download_progress.DownloadProgress.encode(
          message.progress,
          writer.uint32(/* id 4, wireType 2 =*/ 34).fork(),
        ).ldelim();
      if (
        message.segmentCompleted != null &&
        Object.hasOwnProperty.call(message, 'segmentCompleted')
      )
        $root.download_progress.SegmentCompleted.encode(
          message.segmentCompleted,
          writer.uint32(/* id 5, wireType 2 =*/ 42).fork(),
        ).ldelim();
      if (
        message.downloadCompleted != null &&
        Object.hasOwnProperty.call(message, 'downloadCompleted')
      )
        $root.download_progress.DownloadCompleted.encode(
          message.downloadCompleted,
          writer.uint32(/* id 6, wireType 2 =*/ 50).fork(),
        ).ldelim();
      if (
        message.downloadFailed != null &&
        Object.hasOwnProperty.call(message, 'downloadFailed')
      )
        $root.download_progress.DownloadFailed.encode(
          message.downloadFailed,
          writer.uint32(/* id 7, wireType 2 =*/ 58).fork(),
        ).ldelim();
      if (
        message.downloadCancelled != null &&
        Object.hasOwnProperty.call(message, 'downloadCancelled')
      )
        $root.download_progress.DownloadCancelled.encode(
          message.downloadCancelled,
          writer.uint32(/* id 8, wireType 2 =*/ 66).fork(),
        ).ldelim();
      if (message.error != null && Object.hasOwnProperty.call(message, 'error'))
        $root.download_progress.ErrorPayload.encode(
          message.error,
          writer.uint32(/* id 9, wireType 2 =*/ 74).fork(),
        ).ldelim();
      if (
        message.downloadRejected != null &&
        Object.hasOwnProperty.call(message, 'downloadRejected')
      )
        $root.download_progress.DownloadRejected.encode(
    ...
    WsMessage.decode = function decode(reader, length, error) {
      ...
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.download_progress.WsMessage();
      while (reader.pos < end) {
        ...
        switch (tag >>> 3) {
          ...
          case 2: {
            message.snapshot = $root.download_progress.DownloadSnapshot.decode(
              reader,
              reader.uint32(),
            );
            break;
          ...
          case 3: {
            message.downloadStarted =
              $root.download_progress.DownloadStarted.decode(
                reader,
                reader.uint32(),
              );
            break;
          ...
          case 4: {
            message.progress = $root.download_progress.DownloadProgress.decode(
              reader,
              reader.uint32(),
            );
            break;
          ...
          case 5: {
            message.segmentCompleted =
              $root.download_progress.SegmentCompleted.decode(
                reader,
                reader.uint32(),
              );
            break;
          ...
          case 6: {
            message.downloadCompleted =
              $root.download_progress.DownloadCompleted.decode(
                reader,
                reader.uint32(),
              );
            break;
          ...
          case 7: {
            message.downloadFailed =
              $root.download_progress.DownloadFailed.decode(
                reader,
                reader.uint32(),
              );
            break;
          ...
          case 8: {
            message.downloadCancelled =
              $root.download_progress.DownloadCancelled.decode(
                reader,
                reader.uint32(),
              );
            break;
          ...
          case 9: {
            message.error = $root.download_progress.ErrorPayload.decode(
              reader,
              reader.uint32(),
            );
            break;
          ...
          case 10: {
            message.downloadRejected =
              $root.download_progress.DownloadRejected.decode(
                reader,
                reader.uint32(),
              );
            break;
    ...
    WsMessage.verify = function verify(message) {
      ...
      if (message.snapshot != null && message.hasOwnProperty('snapshot')) {
        ...
        {
          let error = $root.download_progress.DownloadSnapshot.verify(
            message.snapshot,
          );
      ...
      if (
        message.downloadStarted != null &&
        message.hasOwnProperty('downloadStarted')
      ) {
        if (properties.payload === 1) return 'payload: multiple values';
        properties.payload = 1;
        {
          let error = $root.download_progress.DownloadStarted.verify(
            message.downloadStarted,
          );
          if (error) return 'downloadStarted.' + error;
        }
      }
      if (message.progress != null && message.hasOwnProperty('progress')) {
        ...
        properties.payload = 1;
        {
          let error = $root.download_progress.DownloadProgress.verify(
            message.progress,
          );
      ...
      if (
        message.segmentCompleted != null &&
        message.hasOwnProperty('segmentCompleted')
      ) {
        if (properties.payload === 1) return 'payload: multiple values';
        properties.payload = 1;
        {
          let error = $root.download_progress.SegmentCompleted.verify(
            message.segmentCompleted,
          );
          if (error) return 'segmentCompleted.' + error;
        }
      }
      if (
        message.downloadCompleted != null &&
        message.hasOwnProperty('downloadCompleted')
      ) {
        if (properties.payload === 1) return 'payload: multiple values';
        properties.payload = 1;
        {
          let error = $root.download_progress.DownloadCompleted.verify(
            message.downloadCompleted,
          );
          if (error) return 'downloadCompleted.' + error;
        }
      }
      if (
        message.downloadFailed != null &&
        message.hasOwnProperty('downloadFailed')
      ) {
        if (properties.payload === 1) return 'payload: multiple values';
        properties.payload = 1;
        {
          let error = $root.download_progress.DownloadFailed.verify(
            message.downloadFailed,
          );
          if (error) return 'downloadFailed.' + error;
        }
      }
      if (
        message.downloadCancelled != null &&
        message.hasOwnProperty('downloadCancelled')
      ) {
        if (properties.payload === 1) return 'payload: multiple values';
        properties.payload = 1;
        {
          let error = $root.download_progress.DownloadCancelled.verify(
            message.downloadCancelled,
          );
          if (error) return 'downloadCancelled.' + error;
        }
      }
      if (message.error != null && message.hasOwnProperty('error')) {
        ...
        properties.payload = 1;
        {
          let error = $root.download_progress.ErrorPayload.verify(
            message.error,
          );
      ...
      if (
        message.downloadRejected != null &&
        message.hasOwnProperty('downloadRejected')
      ) {
        if (properties.payload === 1) return 'payload: multiple values';
        properties.payload = 1;
        {
          let error = $root.download_progress.DownloadRejected.verify(
            message.downloadRejected,
          );
          if (error) return 'downloadRejected.' + error;
        }
      }
      return null;
    };
    ...
    WsMessage.fromObject = function fromObject(object) {
      if (object instanceof $root.download_progress.WsMessage) return object;
      ...
      if (object.snapshot != null) {
        if (typeof object.snapshot !== 'object')
          throw TypeError(
            '.download_progress.WsMessage.snapshot: object expected',
          );
        message.snapshot = $root.download_progress.DownloadSnapshot.fromObject(
          object.snapshot,
        );
      }
      if (object.downloadStarted != null) {
        if (typeof object.downloadStarted !== 'object')
          throw TypeError(
            '.download_progress.WsMessage.downloadStarted: object expected',
          );
        message.downloadStarted =
          $root.download_progress.DownloadStarted.fromObject(
            object.downloadStarted,
          );
      }
      if (object.progress != null) {
        if (typeof object.progress !== 'object')
          throw TypeError(
            '.download_progress.WsMessage.progress: object expected',
          );
        message.progress = $root.download_progress.DownloadProgress.fromObject(
          object.progress,
        );
      }
      if (object.segmentCompleted != null) {
        if (typeof object.segmentCompleted !== 'object')
          throw TypeError(
            '.download_progress.WsMessage.segmentCompleted: object expected',
          );
        message.segmentCompleted =
          $root.download_progress.SegmentCompleted.fromObject(
            object.segmentCompleted,
          );
      }
      if (object.downloadCompleted != null) {
        if (typeof object.downloadCompleted !== 'object')
          throw TypeError(
            '.download_progress.WsMessage.downloadCompleted: object expected',
          );
        message.downloadCompleted =
          $root.download_progress.DownloadCompleted.fromObject(
      ...
      if (object.downloadFailed != null) {
        if (typeof object.downloadFailed !== 'object')
          throw TypeError(
            '.download_progress.WsMessage.downloadFailed: object expected',
          );
        message.downloadFailed =
          $root.download_progress.DownloadFailed.fromObject(
      ...
      if (object.downloadCancelled != null) {
        if (typeof object.downloadCancelled !== 'object')
          throw TypeError(
            '.download_progress.WsMessage.downloadCancelled: object expected',
          );
        message.downloadCancelled =
          $root.download_progress.DownloadCancelled.fromObject(
      ...
      if (object.error != null) {
        if (typeof object.error !== 'object')
          throw TypeError(
            '.download_progress.WsMessage.error: object expected',
          );
        message.error = $root.download_progress.ErrorPayload.fromObject(
          object.error,
        );
      }
      if (object.downloadRejected != null) {
        if (typeof object.downloadRejected !== 'object')
          throw TypeError(
            '.download_progress.WsMessage.downloadRejected: object expected',
          );
        message.downloadRejected =
          $root.download_progress.DownloadRejected.fromObject(
            object.downloadRejected,
          );
      }
      return message;
    };
    ...
    WsMessage.toObject = function toObject(message, options) {
      ...
      if (message.eventType != null && message.hasOwnProperty('eventType'))
        object.eventType =
          options.enums === String
            ? $root.download_progress.EventType[message.eventType] === undefined
              ? message.eventType
              : $root.download_progress.EventType[message.eventType]
            : message.eventType;
      if (message.snapshot != null && message.hasOwnProperty('snapshot')) {
        object.snapshot = $root.download_progress.DownloadSnapshot.toObject(
          message.snapshot,
          options,
        );
        if (options.oneofs) object.payload = 'snapshot';
      }
      if (
        message.downloadStarted != null &&
        message.hasOwnProperty('downloadStarted')
        ...
        object.downloadStarted =
          $root.download_progress.DownloadStarted.toObject(
            message.downloadStarted,
            options,
          );
        if (options.oneofs) object.payload = 'downloadStarted';
      }
      if (message.progress != null && message.hasOwnProperty('progress')) {
        object.progress = $root.download_progress.DownloadProgress.toObject(
          message.progress,
          options,
        );
        if (options.oneofs) object.payload = 'progress';
      }
      if (
        message.segmentCompleted != null &&
        message.hasOwnProperty('segmentCompleted')
        ...
        object.segmentCompleted =
          $root.download_progress.SegmentCompleted.toObject(
            message.segmentCompleted,
            options,
          );
        if (options.oneofs) object.payload = 'segmentCompleted';
      }
      if (
        message.downloadCompleted != null &&
        message.hasOwnProperty('downloadCompleted')
        ...
        object.downloadCompleted =
          $root.download_progress.DownloadCompleted.toObject(
            message.downloadCompleted,
            options,
          );
        if (options.oneofs) object.payload = 'downloadCompleted';
      }
      if (
        message.downloadFailed != null &&
        message.hasOwnProperty('downloadFailed')
      ) {
        object.downloadFailed = $root.download_progress.DownloadFailed.toObject(
          message.downloadFailed,
          options,
        );
        if (options.oneofs) object.payload = 'downloadFailed';
      }
      if (
        message.downloadCancelled != null &&
        message.hasOwnProperty('downloadCancelled')
        ...
        object.downloadCancelled =
          $root.download_progress.DownloadCancelled.toObject(
            message.downloadCancelled,
            options,
          );
        if (options.oneofs) object.payload = 'downloadCancelled';
      }
      if (message.error != null && message.hasOwnProperty('error')) {
        object.error = $root.download_progress.ErrorPayload.toObject(
          message.error,
          options,
        );
      ...
      if (
        ...
        object.downloadRejected =
          $root.download_progress.DownloadRejected.toObject(
            message.downloadRejected,
            options,
          );
        if (options.oneofs) object.payload = 'downloadRejected';
      }
      return object;
    };
  ...
  download_progress.ClientMessage = (function () {
    ...
    ClientMessage.encode = function encode(message, writer) {
      ...
      if (
        ...
        Object.hasOwnProperty.call(message, 'subscribe')
      )
        $root.download_progress.SubscribeRequest.encode(
          message.subscribe,
          writer.uint32(/* id 1, wireType 2 =*/ 10).fork(),
        ).ldelim();
      if (
        message.unsubscribe != null &&
        Object.hasOwnProperty.call(message, 'unsubscribe')
      )
        $root.download_progress.UnsubscribeRequest.encode(
          message.unsubscribe,
          writer.uint32(/* id 2, wireType 2 =*/ 18).fork(),
        ).ldelim();
      return writer;
    ...
    ClientMessage.decode = function decode(reader, length, error) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.download_progress.ClientMessage();
      while (reader.pos < end) {
        let tag = reader.uint32();
        if (tag === error) break;
        switch (tag >>> 3) {
          case 1: {
            message.subscribe = $root.download_progress.SubscribeRequest.decode(
              reader,
              reader.uint32(),
            );
            break;
          ...
          case 2: {
            message.unsubscribe =
              $root.download_progress.UnsubscribeRequest.decode(
                reader,
                reader.uint32(),
              );
            break;
    ...
    ClientMessage.verify = function verify(message) {
      ...
      if (message.subscribe != null && message.hasOwnProperty('subscribe')) {
        properties.action = 1;
        {
          let error = $root.download_progress.SubscribeRequest.verify(
            message.subscribe,
          );
          if (error) return 'subscribe.' + error;
        }
      }
      if (
        message.unsubscribe != null &&
        message.hasOwnProperty('unsubscribe')
      ) {
        if (properties.action === 1) return 'action: multiple values';
        properties.action = 1;
        {
          let error = $root.download_progress.UnsubscribeRequest.verify(
            message.unsubscribe,
          );
          if (error) return 'unsubscribe.' + error;
        }
      }
      return null;
    };
    ...
    ClientMessage.fromObject = function fromObject(object) {
      ...
      if (object.subscribe != null) {
        if (typeof object.subscribe !== 'object')
          throw TypeError(
            '.download_progress.ClientMessage.subscribe: object expected',
          );
        message.subscribe = $root.download_progress.SubscribeRequest.fromObject(
          object.subscribe,
        );
      }
      if (object.unsubscribe != null) {
        if (typeof object.unsubscribe !== 'object')
          throw TypeError(
            '.download_progress.ClientMessage.unsubscribe: object expected',
          );
        message.unsubscribe =
          $root.download_progress.UnsubscribeRequest.fromObject(
            object.unsubscribe,
          );
      }
      return message;
    ...
    ClientMessage.toObject = function toObject(message, options) {
      ...
      let object = {};
      if (message.subscribe != null && message.hasOwnProperty('subscribe')) {
        object.subscribe = $root.download_progress.SubscribeRequest.toObject(
          message.subscribe,
          options,
        );
        if (options.oneofs) object.action = 'subscribe';
      }
      if (
        message.unsubscribe != null &&
        message.hasOwnProperty('unsubscribe')
        ...
        object.unsubscribe =
          $root.download_progress.UnsubscribeRequest.toObject(
            message.unsubscribe,
            options,
          );
        if (options.oneofs) object.action = 'unsubscribe';
      }
      return object;
    };
  ...
  download_progress.SubscribeRequest = (function () {
    ...
    SubscribeRequest.encode = function encode(message, writer) {
      if (!writer) writer = $Writer.create();
      if (
        message.streamerId != null &&
        Object.hasOwnProperty.call(message, 'streamerId')
      )
     ...
     * @returns {$protobuf.Writer} Writer
     */
    SubscribeRequest.encodeDelimited = function encodeDelimited(
      message,
      writer,
    ) {
      return this.encode(message, writer).ldelim();
    ...
    SubscribeRequest.decode = function decode(reader, length, error) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.download_progress.SubscribeRequest();
      while (reader.pos < end) {
        let tag = reader.uint32();
        if (tag === error) break;
        switch (tag >>> 3) {
    ...
    SubscribeRequest.toObject = function toObject(message, options) {
      if (!options) options = {};
      let object = {};
      if (options.defaults) object.streamerId = '';
      if (message.streamerId != null && message.hasOwnProperty('streamerId'))
  ...
  download_progress.UnsubscribeRequest = (function () {
     ...
     * @returns {$protobuf.Writer} Writer
     */
    UnsubscribeRequest.encodeDelimited = function encodeDelimited(
      message,
      writer,
    ) {
      return this.encode(message, writer).ldelim();
    ...
    UnsubscribeRequest.decode = function decode(reader, length, error) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.download_progress.UnsubscribeRequest();
      while (reader.pos < end) {
        let tag = reader.uint32();
        if (tag === error) break;
        switch (tag >>> 3) {
  ...
  download_progress.DownloadSnapshot = (function () {
     ...
     * @returns {$protobuf.Writer} Writer
     */
    DownloadSnapshot.encodeDelimited = function encodeDelimited(
      message,
      writer,
    ) {
      return this.encode(message, writer).ldelim();
    ...
    DownloadSnapshot.decode = function decode(reader, length, error) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.download_progress.DownloadSnapshot();
      while (reader.pos < end) {
        let tag = reader.uint32();
        if (tag === error) break;
        switch (tag >>> 3) {
          case 1: {
            if (!(message.downloads && message.downloads.length))
              message.downloads = [];
            message.downloads.push(
              $root.download_progress.DownloadProgress.decode(
                reader,
                reader.uint32(),
              ),
            );
    ...
    DownloadSnapshot.verify = function verify(message) {
      ...
      if (message.downloads != null && message.hasOwnProperty('downloads')) {
        ...
        for (let i = 0; i < message.downloads.length; ++i) {
          ...
          if (error) return 'downloads.' + error;
        }
      }
      return null;
    };
    ...
    DownloadSnapshot.fromObject = function fromObject(object) {
      ...
      if (object.downloads) {
        if (!Array.isArray(object.downloads))
          throw TypeError(
            '.download_progress.DownloadSnapshot.downloads: array expected',
          );
        message.downloads = [];
        for (let i = 0; i < object.downloads.length; ++i) {
          if (typeof object.downloads[i] !== 'object')
            throw TypeError(
              '.download_progress.DownloadSnapshot.downloads: object expected',
            );
          message.downloads[i] =
            $root.download_progress.DownloadProgress.fromObject(
              object.downloads[i],
            );
        }
      }
    ...
    DownloadSnapshot.toObject = function toObject(message, options) {
      if (!options) options = {};
      let object = {};
      if (options.arrays || options.defaults) object.downloads = [];
      if (message.downloads && message.downloads.length) {
        object.downloads = [];
        for (let j = 0; j < message.downloads.length; ++j)
          object.downloads[j] =
            $root.download_progress.DownloadProgress.toObject(
              message.downloads[j],
              options,
            );
      }
  ...
  download_progress.DownloadProgress = (function () {
     ...
     * @instance
     */
    DownloadProgress.prototype.bytesDownloaded = $util.Long
     ...
     * @instance
     */
    DownloadProgress.prototype.speedBytesPerSec = $util.Long
      ? $util.Long.fromBits(0, 0, true)
      : 0;
     ...
     * @instance
     */
    DownloadProgress.prototype.startedAtMs = $util.Long
    ...
    DownloadProgress.encode = function encode(message, writer) {
      if (!writer) writer = $Writer.create();
      if (
        message.downloadId != null &&
        Object.hasOwnProperty.call(message, 'downloadId')
      )
      ...
      if (
        message.engineType != null &&
        Object.hasOwnProperty.call(message, 'engineType')
      )
      ...
      if (
        message.bytesDownloaded != null &&
        Object.hasOwnProperty.call(message, 'bytesDownloaded')
      )
        writer
          .uint32(/* id 6, wireType 0 =*/ 48)
          .uint64(message.bytesDownloaded);
      if (
        message.durationSecs != null &&
        Object.hasOwnProperty.call(message, 'durationSecs')
      )
        writer.uint32(/* id 7, wireType 1 =*/ 57).double(message.durationSecs);
      if (
        message.speedBytesPerSec != null &&
        Object.hasOwnProperty.call(message, 'speedBytesPerSec')
      )
        writer
          .uint32(/* id 8, wireType 0 =*/ 64)
          .uint64(message.speedBytesPerSec);
      if (
        message.segmentsCompleted != null &&
        Object.hasOwnProperty.call(message, 'segmentsCompleted')
      )
        writer
          .uint32(/* id 9, wireType 0 =*/ 72)
          .uint32(message.segmentsCompleted);
      if (
        message.mediaDurationSecs != null &&
        Object.hasOwnProperty.call(message, 'mediaDurationSecs')
      )
        writer
          .uint32(/* id 10, wireType 1 =*/ 81)
          .double(message.mediaDurationSecs);
      if (
        message.playbackRatio != null &&
        Object.hasOwnProperty.call(message, 'playbackRatio')
      )
        writer
          .uint32(/* id 11, wireType 1 =*/ 89)
          .double(message.playbackRatio);
      if (
        message.startedAtMs != null &&
        Object.hasOwnProperty.call(message, 'startedAtMs')
      )
     ...
     * @returns {$protobuf.Writer} Writer
     */
    DownloadProgress.encodeDelimited = function encodeDelimited(
      message,
      writer,
    ) {
      return this.encode(message, writer).ldelim();
    ...
    DownloadProgress.decode = function decode(reader, length, error) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.download_progress.DownloadProgress();
      while (reader.pos < end) {
        let tag = reader.uint32();
        if (tag === error) break;
        switch (tag >>> 3) {
    ...
    DownloadProgress.verify = function verify(message) {
      ...
      if (
        message.bytesDownloaded != null &&
        message.hasOwnProperty('bytesDownloaded')
      )
        if (
          !$util.isInteger(message.bytesDownloaded) &&
          !(
            message.bytesDownloaded &&
            $util.isInteger(message.bytesDownloaded.low) &&
            $util.isInteger(message.bytesDownloaded.high)
          )
        )
          return 'bytesDownloaded: integer|Long expected';
      if (
        message.durationSecs != null &&
        message.hasOwnProperty('durationSecs')
      )
        if (typeof message.durationSecs !== 'number')
          return 'durationSecs: number expected';
      if (
        message.speedBytesPerSec != null &&
        message.hasOwnProperty('speedBytesPerSec')
      )
        if (
          !$util.isInteger(message.speedBytesPerSec) &&
          !(
            message.speedBytesPerSec &&
            $util.isInteger(message.speedBytesPerSec.low) &&
            $util.isInteger(message.speedBytesPerSec.high)
          )
        )
          return 'speedBytesPerSec: integer|Long expected';
      if (
        message.segmentsCompleted != null &&
        message.hasOwnProperty('segmentsCompleted')
      )
        if (!$util.isInteger(message.segmentsCompleted))
          return 'segmentsCompleted: integer expected';
      if (
        message.mediaDurationSecs != null &&
        message.hasOwnProperty('mediaDurationSecs')
      )
        if (typeof message.mediaDurationSecs !== 'number')
          return 'mediaDurationSecs: number expected';
      if (
        message.playbackRatio != null &&
        message.hasOwnProperty('playbackRatio')
      )
    ...
    DownloadProgress.fromObject = function fromObject(object) {
      ...
      if (object.bytesDownloaded != null)
        if ($util.Long)
          (message.bytesDownloaded = $util.Long.fromValue(
            object.bytesDownloaded,
          )).unsigned = true;
          ...
          message.bytesDownloaded = new $util.LongBits(
            object.bytesDownloaded.low >>> 0,
            object.bytesDownloaded.high >>> 0,
          ).toNumber(true);
      if (object.durationSecs != null)
        message.durationSecs = Number(object.durationSecs);
      if (object.speedBytesPerSec != null)
        if ($util.Long)
          (message.speedBytesPerSec = $util.Long.fromValue(
          ...
          message.speedBytesPerSec = new $util.LongBits(
            object.speedBytesPerSec.low >>> 0,
            object.speedBytesPerSec.high >>> 0,
          ).toNumber(true);
      ...
      if (object.startedAtMs != null)
        if ($util.Long)
          (message.startedAtMs = $util.Long.fromValue(
            object.startedAtMs,
          )).unsigned = false;
    ...
    DownloadProgress.toObject = function toObject(message, options) {
          ...
          object.bytesDownloaded =
            options.longs === String
              ...
              : options.longs === Number
                ? long.toNumber()
                : long;
        } else object.bytesDownloaded = options.longs === String ? '0' : 0;
          ...
          object.speedBytesPerSec =
            options.longs === String
              ...
              : options.longs === Number
                ? long.toNumber()
                : long;
        } else object.speedBytesPerSec = options.longs === String ? '0' : 0;
          ...
          object.startedAtMs =
            options.longs === String
              ...
              : options.longs === Number
                ? long.toNumber()
                : long;
        } else object.startedAtMs = options.longs === String ? '0' : 0;
      }
      if (message.downloadId != null && message.hasOwnProperty('downloadId'))
      ...
      if (
        ...
        if (typeof message.bytesDownloaded === 'number')
          object.bytesDownloaded =
            options.longs === String
              ? String(message.bytesDownloaded)
              : message.bytesDownloaded;
        else
          object.bytesDownloaded =
            options.longs === String
              ? $util.Long.prototype.toString.call(message.bytesDownloaded)
              : options.longs === Number
                ? new $util.LongBits(
                    message.bytesDownloaded.low >>> 0,
                    message.bytesDownloaded.high >>> 0,
                  ).toNumber(true)
                : message.bytesDownloaded;
      if (
        message.durationSecs != null &&
        ...
        object.durationSecs =
          options.json && !isFinite(message.durationSecs)
            ? String(message.durationSecs)
      ...
      if (
        ...
        if (typeof message.speedBytesPerSec === 'number')
          object.speedBytesPerSec =
            options.longs === String
              ? String(message.speedBytesPerSec)
              : message.speedBytesPerSec;
        else
          object.speedBytesPerSec =
            options.longs === String
              ? $util.Long.prototype.toString.call(message.speedBytesPerSec)
              : options.longs === Number
                ? new $util.LongBits(
                    message.speedBytesPerSec.low >>> 0,
                    message.speedBytesPerSec.high >>> 0,
                  ).toNumber(true)
                : message.speedBytesPerSec;
      if (
        message.segmentsCompleted != null &&
      ...
      if (
        ...
        object.mediaDurationSecs =
          options.json && !isFinite(message.mediaDurationSecs)
            ? String(message.mediaDurationSecs)
            : message.mediaDurationSecs;
      if (
        message.playbackRatio != null &&
        message.hasOwnProperty('playbackRatio')
      )
        object.playbackRatio =
          options.json && !isFinite(message.playbackRatio)
            ? String(message.playbackRatio)
            : message.playbackRatio;
      if (message.startedAtMs != null && message.hasOwnProperty('startedAtMs'))
        if (typeof message.startedAtMs === 'number')
          object.startedAtMs =
            options.longs === String
              ? String(message.startedAtMs)
              : message.startedAtMs;
        else
          object.startedAtMs =
            options.longs === String
              ...
              : options.longs === Number
                ? new $util.LongBits(
                    message.startedAtMs.low >>> 0,
                    message.startedAtMs.high >>> 0,
                  ).toNumber()
                : message.startedAtMs;
      return object;
    };
  ...
  download_progress.DownloadStarted = (function () {
     ...
     * @instance
     */
    DownloadStarted.prototype.startedAtMs = $util.Long
      ? $util.Long.fromBits(0, 0, false)
      : 0;
     ...
     * @returns {$protobuf.Writer} Writer
     */
    DownloadStarted.encodeDelimited = function encodeDelimited(
      message,
      writer,
    ) {
      return this.encode(message, writer).ldelim();
    ...
    DownloadStarted.decode = function decode(reader, length, error) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.download_progress.DownloadStarted();
      while (reader.pos < end) {
        let tag = reader.uint32();
        if (tag === error) break;
        switch (tag >>> 3) {
  ...
  download_progress.SegmentCompleted = (function () {
     ...
     * @instance
     */
    SegmentCompleted.prototype.sizeBytes = $util.Long
      ? $util.Long.fromBits(0, 0, true)
      : 0;
    ...
    SegmentCompleted.encode = function encode(message, writer) {
      ...
      if (
        ...
        writer.uint32(/* id 2, wireType 2 =*/ 18).string(message.streamerId);
      if (
        message.segmentPath != null &&
        Object.hasOwnProperty.call(message, 'segmentPath')
      )
     ...
     * @returns {$protobuf.Writer} Writer
     */
    SegmentCompleted.encodeDelimited = function encodeDelimited(
      message,
      writer,
    ) {
      return this.encode(message, writer).ldelim();
    ...
    SegmentCompleted.decode = function decode(reader, length, error) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.download_progress.SegmentCompleted();
      while (reader.pos < end) {
        let tag = reader.uint32();
        if (tag === error) break;
        switch (tag >>> 3) {
    ...
    SegmentCompleted.verify = function verify(message) {
      ...
      if (message.sizeBytes != null && message.hasOwnProperty('sizeBytes'))
        if (
          ...
          !(
            message.sizeBytes &&
            $util.isInteger(message.sizeBytes.low) &&
            $util.isInteger(message.sizeBytes.high)
          )
        )
    ...
    SegmentCompleted.fromObject = function fromObject(object) {
      ...
      if (object.sizeBytes != null)
        if ($util.Long)
          (message.sizeBytes = $util.Long.fromValue(
            object.sizeBytes,
          )).unsigned = true;
          ...
          message.sizeBytes = new $util.LongBits(
            object.sizeBytes.low >>> 0,
            object.sizeBytes.high >>> 0,
          ).toNumber(true);
      if (object.sessionId != null)
        message.sessionId = String(object.sessionId);
      return message;
    ...
    SegmentCompleted.toObject = function toObject(message, options) {
          ...
          object.sizeBytes =
            options.longs === String
              ...
              : options.longs === Number
                ? long.toNumber()
                : long;
        } else object.sizeBytes = options.longs === String ? '0' : 0;
        object.sessionId = '';
      }
      if (message.downloadId != null && message.hasOwnProperty('downloadId'))
        object.downloadId = message.downloadId;
      ...
      if (message.sizeBytes != null && message.hasOwnProperty('sizeBytes'))
        if (typeof message.sizeBytes === 'number')
          ...
          object.sizeBytes =
            options.longs === String
              ? $util.Long.prototype.toString.call(message.sizeBytes)
              : options.longs === Number
                ? new $util.LongBits(
                    message.sizeBytes.low >>> 0,
                    message.sizeBytes.high >>> 0,
                  ).toNumber(true)
                : message.sizeBytes;
      if (message.sessionId != null && message.hasOwnProperty('sessionId'))
        object.sessionId = message.sessionId;
  ...
  download_progress.DownloadCompleted = (function () {
     ...
     * @instance
     */
    DownloadCompleted.prototype.totalBytes = $util.Long
      ? $util.Long.fromBits(0, 0, true)
      : 0;
    ...
    DownloadCompleted.encode = function encode(message, writer) {
      ...
      if (
        ...
        Object.hasOwnProperty.call(message, 'totalBytes')
      )
        writer.uint32(/* id 4, wireType 0 =*/ 32).uint64(message.totalBytes);
      if (
        message.totalDurationSecs != null &&
        Object.hasOwnProperty.call(message, 'totalDurationSecs')
      )
        writer
          .uint32(/* id 5, wireType 1 =*/ 41)
          .double(message.totalDurationSecs);
      if (
        message.totalSegments != null &&
        Object.hasOwnProperty.call(message, 'totalSegments')
      )
     ...
     * @returns {$protobuf.Writer} Writer
     */
    DownloadCompleted.encodeDelimited = function encodeDelimited(
      message,
      writer,
    ) {
      return this.encode(message, writer).ldelim();
    ...
    DownloadCompleted.decode = function decode(reader, length, error) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.download_progress.DownloadCompleted();
      while (reader.pos < end) {
        let tag = reader.uint32();
        if (tag === error) break;
        switch (tag >>> 3) {
    ...
    DownloadCompleted.verify = function verify(message) {
      ...
      if (message.totalBytes != null && message.hasOwnProperty('totalBytes'))
        if (
          !$util.isInteger(message.totalBytes) &&
          !(
            message.totalBytes &&
            $util.isInteger(message.totalBytes.low) &&
            $util.isInteger(message.totalBytes.high)
          )
        )
          return 'totalBytes: integer|Long expected';
      if (
        message.totalDurationSecs != null &&
        message.hasOwnProperty('totalDurationSecs')
      )
        if (typeof message.totalDurationSecs !== 'number')
          return 'totalDurationSecs: number expected';
      if (
        message.totalSegments != null &&
        message.hasOwnProperty('totalSegments')
      )
    ...
    DownloadCompleted.fromObject = function fromObject(object) {
      ...
      if (object.totalBytes != null)
        if ($util.Long)
          (message.totalBytes = $util.Long.fromValue(
            object.totalBytes,
          )).unsigned = true;
          ...
          message.totalBytes = new $util.LongBits(
            object.totalBytes.low >>> 0,
            object.totalBytes.high >>> 0,
          ).toNumber(true);
    ...
    DownloadCompleted.toObject = function toObject(message, options) {
      ...
      if (message.totalBytes != null && message.hasOwnProperty('totalBytes'))
        if (typeof message.totalBytes === 'number')
          object.totalBytes =
            options.longs === String
              ? String(message.totalBytes)
              : message.totalBytes;
        else
          object.totalBytes =
            options.longs === String
              ? $util.Long.prototype.toString.call(message.totalBytes)
              : options.longs === Number
                ? new $util.LongBits(
                    message.totalBytes.low >>> 0,
                    message.totalBytes.high >>> 0,
                  ).toNumber(true)
                : message.totalBytes;
      if (
        message.totalDurationSecs != null &&
        ...
        object.totalDurationSecs =
          options.json && !isFinite(message.totalDurationSecs)
            ? String(message.totalDurationSecs)
            : message.totalDurationSecs;
      if (
        message.totalSegments != null &&
        message.hasOwnProperty('totalSegments')
      )
  ...
  download_progress.DownloadFailed = (function () {
    ...
    DownloadFailed.encode = function encode(message, writer) {
      ...
      if (
        message.recoverable != null &&
        Object.hasOwnProperty.call(message, 'recoverable')
      )
    ...
    DownloadFailed.decode = function decode(reader, length, error) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.download_progress.DownloadFailed();
      while (reader.pos < end) {
        let tag = reader.uint32();
        if (tag === error) break;
        switch (tag >>> 3) {
  ...
  download_progress.DownloadCancelled = (function () {
     ...
     * @returns {$protobuf.Writer} Writer
     */
    DownloadCancelled.encodeDelimited = function encodeDelimited(
      message,
      writer,
    ) {
      return this.encode(message, writer).ldelim();
    ...
    DownloadCancelled.decode = function decode(reader, length, error) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.download_progress.DownloadCancelled();
      while (reader.pos < end) {
        let tag = reader.uint32();
        if (tag === error) break;
        switch (tag >>> 3) {
    ...
    DownloadCancelled.verify = function verify(message) {
      ...
      if (message.cause != null && message.hasOwnProperty('cause'))
        if (!$util.isString(message.cause)) return 'cause: string expected';
      return null;
    };
    ...
    DownloadCancelled.fromObject = function fromObject(object) {
      ...
      if (object.sessionId != null)
        message.sessionId = String(object.sessionId);
      if (object.cause != null) message.cause = String(object.cause);
      return message;
    };
  ...
  download_progress.DownloadRejected = (function () {
     ...
     * @instance
     */
    DownloadRejected.prototype.retryAfterSecs = $util.Long
      ? $util.Long.fromBits(0, 0, true)
      : 0;
    ...
    DownloadRejected.encode = function encode(message, writer) {
      ...
      if (
        message.retryAfterSecs != null &&
        Object.hasOwnProperty.call(message, 'retryAfterSecs')
      )
        writer
          .uint32(/* id 4, wireType 0 =*/ 32)
          .uint64(message.retryAfterSecs);
      if (
        message.recoverable != null &&
        Object.hasOwnProperty.call(message, 'recoverable')
      )
     ...
     * @returns {$protobuf.Writer} Writer
     */
    DownloadRejected.encodeDelimited = function encodeDelimited(
      message,
      writer,
    ) {
      return this.encode(message, writer).ldelim();
    ...
    DownloadRejected.decode = function decode(reader, length, error) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.download_progress.DownloadRejected();
      while (reader.pos < end) {
        let tag = reader.uint32();
        if (tag === error) break;
        switch (tag >>> 3) {
    ...
    DownloadRejected.verify = function verify(message) {
      ...
      if (
        message.retryAfterSecs != null &&
        message.hasOwnProperty('retryAfterSecs')
      )
        if (
          !$util.isInteger(message.retryAfterSecs) &&
          !(
            message.retryAfterSecs &&
            $util.isInteger(message.retryAfterSecs.low) &&
            $util.isInteger(message.retryAfterSecs.high)
          )
        )
    ...
    DownloadRejected.fromObject = function fromObject(object) {
      ...
      if (object.retryAfterSecs != null)
        if ($util.Long)
          (message.retryAfterSecs = $util.Long.fromValue(
            object.retryAfterSecs,
          )).unsigned = true;
          ...
          message.retryAfterSecs = new $util.LongBits(
            object.retryAfterSecs.low >>> 0,
            object.retryAfterSecs.high >>> 0,
          ).toNumber(true);
      if (object.recoverable != null)
        message.recoverable = Boolean(object.recoverable);
      return message;
    ...
    DownloadRejected.toObject = function toObject(message, options) {
          ...
          object.retryAfterSecs =
            options.longs === String
              ...
              : options.longs === Number
                ? long.toNumber()
                : long;
        } else object.retryAfterSecs = options.longs === String ? '0' : 0;
        object.recoverable = false;
      }
      if (message.streamerId != null && message.hasOwnProperty('streamerId'))
        object.streamerId = message.streamerId;
      ...
      if (
        ...
        if (typeof message.retryAfterSecs === 'number')
          object.retryAfterSecs =
            options.longs === String
              ? String(message.retryAfterSecs)
              : message.retryAfterSecs;
        else
          object.retryAfterSecs =
            options.longs === String
              ? $util.Long.prototype.toString.call(message.retryAfterSecs)
              : options.longs === Number
                ? new $util.LongBits(
                    message.retryAfterSecs.low >>> 0,
                    message.retryAfterSecs.high >>> 0,
                  ).toNumber(true)
                : message.retryAfterSecs;
      if (message.recoverable != null && message.hasOwnProperty('recoverable'))
        object.recoverable = message.recoverable;
  ...
  download_progress.ErrorPayload = (function () {
    ...
    ErrorPayload.decode = function decode(reader, length, error) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.download_progress.ErrorPayload();
      while (reader.pos < end) {
        let tag = reader.uint32();
        if (tag === error) break;
        switch (tag >>> 3) {
    ...
    ErrorPayload.fromObject = function fromObject(object) {
      if (object instanceof $root.download_progress.ErrorPayload) return object;
